...
describe('sample code', () => {
  ...
  test('sample-code-sample.md', () => {
    expect('../sample/sample-code-sample.md' as const).toMatchSampleCode();
  });
  test('sample-code-sample-not-exist-file.md', () => {
    expect(() => {
      expect(
        '../sample/sample-code-sample-not-exist-file.md' as const,
      ).toMatchSampleCode();
  ...
  test('sample-code-sample-not-exist-hash.md', () => {
    expect(() => {
      expect(
        '../sample/sample-code-sample-not-exist-hash.md' as const,
      ).toMatchSampleCode();
    }).toThrow(
  ...
  test('sample-code-sample-different.md', () => {
    expect(() => {
      expect(
        '../sample/sample-code-sample-different.md' as const,
      ).toMatchSampleCode();
...
describe('error', () => {
  test('not', () => {
    expect(() => {
      expect('../README.md' as const).not.toMatchSampleCode();
    }).toThrow('.not.toMatchSampleCode is unsupported.');
  });
  test('no sample', () => {
    expect(() => {
      expect(
        '../sample/sample-code-sample-no-sample.md' as const,
      ).toMatchSampleCode();
